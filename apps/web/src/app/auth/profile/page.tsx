...
export default async function ProfilePage({ searchParams }: ProfilePageProps) {
  ...
  return (
    <div className="bg-background w-full self-stretch">
      <div className="container mx-auto py-8">
        <div className="border-border/60 via-background mb-8 overflow-hidden rounded-3xl border bg-linear-to-r from-slate-50 to-blue-50/70 shadow-sm">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="text-muted-foreground mt-2 max-w-2xl text-sm sm:text-base">
                  Atualize suas informações pessoais e acompanhe os dados
                  principais da sua conta no ColdMonitor.
                </p>
              </div>
            </div>
          </div>
                ...
                <CardContent className="space-y-4 px-6 py-5">
                  ...
                  <div className="border-border/60 bg-muted/30 rounded-2xl border p-4">
                    ...
                    <p className="text-muted-foreground mt-2 text-sm">
                      Suas permissões e dados de conta aparecem organizados ao
                      lado para consulta rápida.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-border/60">
                ...
                <CardContent className="space-y-4">
                  <div className="border-border/60 bg-muted/20 rounded-xl border p-4">
                    <Label className="text-muted-foreground text-[11px] tracking-[0.16em] uppercase">
                      Data de Ingresso
                    </Label>
                    <p className="mt-2 text-sm font-medium">
                      {user.createdAt
            ...
            <div className="space-y-6">
              ...
              <Card className="border-border/60">
                <CardHeader className="border-border/60 border-b">
                  ...
                  <CardDescription>
                    Atualize os dados principais exibidos na sua conta.
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border-border/60">
                <CardHeader className="border-border/60 border-b">
                  ...
                  <CardDescription>
                    Uma visão rápida dos dados mais importantes do seu cadastro.
                  </CardDescription>
                </CardHeader>
