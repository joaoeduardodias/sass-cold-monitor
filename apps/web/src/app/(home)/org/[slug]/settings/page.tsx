...
export default async function SettingsPage({
  ...
  const defaultTab = tabValues.includes(
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie as configurações globais do ColdMonitor
            </p>
          </div>
        </div>

        <Tabs defaultValue={defaultTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-6 px-2 transition-all duration-300 ease-in-out">
            <TabsTrigger
              value="general"
              className="flex cursor-pointer items-center gap-2 transition-all duration-200 ease-in-out data-[state=active]:scale-105"
            >
          ...
          <TabsContent
            value="general"
            className="animate-in fade-in-50 space-y-4 duration-400"
          >
            {canUpdateOrganization && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configurações básicas do sistema e empresa
                  </CardDescription>
                </CardHeader>
            ...
            {canShutdownOrganization && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Isso irá excluir todos os dados da organização, incluindo
                    todos os instrumentos. Você não pode desfazer essa ação.
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Siga este passo a passo para concluir a integracao do coletor
                  com o servidor.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ol className="text-muted-foreground list-decimal space-y-2 pl-5 text-sm">
                  <li>
                    Acesse o Sitrad PRO e abra as configuracoes do servidor.
                  </li>
                  ...
                  <li>
                    Crie um grupo para a API e conceda permissoes de leitura e
                    escrita.
                  </li>
                </ol>
              </CardContent>
          ...
          <TabsContent
            value="instruments"
            className="animate-in fade-in-50 duration-400"
          >
            <Card>
              <CardHeader>
                <CardTitle>Configuração das Câmaras</CardTitle>
                <CardDescription>
                  Gerencie todas as câmaras frias em um só local
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ChamberSettings
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure alertas globais e métodos de notificação
                </CardDescription>
              </CardHeader>
              <CardContent>
                <NotificationSettings
                  organizationSlug={currentOrg ?? undefined}
                />
              </CardContent>
            </Card>
          </TabsContent>
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure autenticação, logs e políticas de segurança
                </CardDescription>
              </CardHeader>
              <CardContent>
